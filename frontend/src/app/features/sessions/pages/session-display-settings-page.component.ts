...
@Component({
  ...
  `,
  styles: `.page,.stack{display:grid;gap:1rem}.hero{display:grid;gap:.5rem}.eyebrow{margin:0;color:#0f766e;text-transform:uppercase;letter-spacing:.12em;font-size:.72rem}.lede{margin:0;max-width:42rem;color:#475569}.panel{max-width:36rem;background:#fff;padding:1.25rem;border-radius:1.25rem;box-shadow:0 18px 40px rgba(15,23,42,.08)}.field{display:grid;gap:.45rem}.field span{font-size:.86rem;font-weight:700;color:#334155}.actions{display:flex;gap:.75rem;flex-wrap:wrap}input,button,a{padding:.85rem .95rem;border-radius:.85rem;border:1px solid #cbd5e1;font:inherit;text-decoration:none}button{background:#0f172a;color:#fff;border:0;font-weight:700;cursor:pointer}.ghost{background:#fff;color:#334155}`,
})
